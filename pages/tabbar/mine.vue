<template>
	<view>
		...
		<DialogPay :hasVerification.sync="hasVerification" @confirmIdentify="confirmIdentify">
			<view slot="title">支付密码</view>
			<view slot="main-title">请输入支付密码进行认购</view>
		</DialogPay>
		<view class="container">
			<view class="section-background"></view>
			<NavBar :showLeft="false" title="MINE">
			</NavBar>
			<view class="section-userinfo d-flex align-items-center justify-between">
				<view class="d-flex align-items-center">
					<view class="image">
						<u--image :showLoading="true" src="https://cdn.uviewui.com/uview/album/1.jpg" width="63px"
							height="63px" radius="20"></u--image>
				...
				<u--image :showLoading="true" src="/static/images/section/service.png" width="30px" height="30px">
				</u--image>
			</view>
			<view class="section-main">
				<u--image src="/static/images/section/mine_banner.png" width="100%" height="100px" mode="widthFix"
				...
				<view class="section-apply">
					...
					<view class="content">
						<view class="item d-flex align-items-center justify-between" v-for="(item,index) in applyList"
							:key="index" @click="handleMenuClick(item)">
							<template>
								<view class="d-flex align-items-center">
									<u--image :src="item.icon" width="25px" height="25px" mode="widthFix"></u--image>
									<text class="title">{{item.title}}</text>
								</view>
								<view class="">
									<u--image src="/static/images/icon/right.png" width="15px" height="15px"
