<template>
	<view class="container">
		<NavBar :showLeft="false" title="Win by all">
		</NavBar>
		<view class="section-main">
			...
			<view class="section-icon d-flex justify-around">
				<view class="item d-flex flex-cloumn justify-center align-items-center" v-for="(item,index) in iconList"
			...
			<view class="section-list">
				<view class="title">
					<u--image :showLoading="true" src="/static/images/section/home_title.png" width="203px"
						height="38px">
					</u--image>
				</view>
				<view class="box_100">
					<view class="section_8">
						...
						<view class="auction">
							<swiper class="swiper" :circular="false" :indicator-dots="false" :autoplay="false"
								:duration="800" next-margin="160rpx">
