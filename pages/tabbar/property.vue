<template>
	<view>
		...
		<swiper class="section-swiper" :indicator-dots="true" :autoplay="false" :interval="3000" :duration="1000"
			next-margin="50rpx" previous-margin="50rpx" indicator-active-color="#D2AE78" indicator-color="#7B7B7B"
			@change="handleChange">
			<swiper-item>
				<view class="swiper-item first">
					<view class="info d-flex">
						<u--image :showLoading="true" src="/static/images/common/usdt.png" width="23px" height="23px">
						</u--image>
						<view class="money">USDT</view>
					</view>
					<view class="usable">可用USDT</view>
					<view class="balance">17562.000000</view>
			...
			<swiper-item>
				<view class="swiper-item second">
					<view class="info d-flex">
						<u--image :showLoading="true" src="/static/images/common/nt.png" width="23px" height="23px">
						</u--image>
		...
		<view class="section-first" v-show="current !== 1">
			<view class="section-icon d-flex justify-around">
				<view v-for="(item,index) in usdtList" :key="index">
					<view class="image">
						<u--image :showLoading="true" :src="item.icon" width="57px" height="57px"></u--image>
					</view>
					<view class="title">
						{{item.title}}
					</view>
			...
			<view class="section-list">
				...
				<view class="content">
					<view class="item d-flex align-items-center justify-between" v-for="(item,index) in detailList"
						:key="index">
						<view>
							<view class="title">
								{{item.title}}
		...
		<view class="section-second" v-show="current == 1">
			<view class="section-icon d-flex justify-around">
				<view v-for="(item,index) in ntList" :key="index">
					<view class="image">
						<u--image :showLoading="true" :src="item.icon" width="57px" height="57px"></u--image>
					</view>
					<view class="title">
	...
	export default {
		data() {
			return {
				...
				detailList: [{
					title: '充值',
					createtime: '2022.12.22  16：40：30',
					money: '15420.00'
				}]
			}
		},
