		...
		<view class="d-flex flex-cloumn justify-between section-main">
			<view class="section-list">
				<view>
					...
					<view class="item d-flex align-items-center justify-between" v-for="(item,index) in levelList"
						:key="index">
			...
			<view class="button">
				<u-button text="立即认购" color="linear-gradient(180deg, #D7AE73 0%, #DBC395 100%)" size="large"
					@click="hasVerification = true"></u-button>
			</view>
		</view>
		<DialogPay :hasVerification.sync="hasVerification" @confirmIdentify="buyLevel">
